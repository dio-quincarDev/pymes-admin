...
public class SetupController implements SetupApi {
    ...
    @Override
    public ResponseEntity<TenantSetup> getOrInitialize(UUID tenantId) {
    ...
    @Override
    public ResponseEntity<TenantSetup> completeOnboarding(UUID tenantId, Map<String, String> body) {
